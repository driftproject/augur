...
contract Augur is IAugur {
    ...
    function registerContract(bytes32 _key, address _address) public returns (bool) {
        ...
        if (_key == "CompleteSets" || _key == "Orders" || _key == "CreateOrder" || _key == "CancelOrder" || _key == "FillOrder" || _key == "Trade" || _key == "ClaimTradingProceeds" || _key == "Auction" || _key == "MarketFactory") {
    ...
    function isKnownMarketCreatorFeeSender(address _feeSender) public view returns (bool) {
        return _feeSender == registry["CompleteSets"] || _feeSender == registry["ClaimTradingProceeds"];
    }
